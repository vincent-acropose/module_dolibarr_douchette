 ...
 */
class douchettebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "douchette@douchette";
    public $boxlabel;
    public $depends = array("douchette");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/douchette/class/douchette.class.php";
